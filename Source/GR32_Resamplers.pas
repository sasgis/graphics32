...
begin
  ...
  BlockTransferExt(Dst, DstX, DstY, DstClip, Src.Bits, Src.Width, Src.Height,
...
begin
  ...
  begin
    ...
    BlendBlock(Dst, DstClip, SrcBits, SrcWidth, SrcHeight, SrcRect.Left, SrcRect.Top, OuterColor, CombineOp, CombineMode, MasterAlpha, CombineCallBack);
  end;
 ...
 { rangechecking and rect intersection done by caller }
  ...
  begin
    if (SrcW < 2) or (SrcH < 2) then
      Resample(Dst, DstRect, DstClip, SrcBits, SrcWidth, SrcHeight, SrcRect, Kernel, OuterColor, CombineOp, CombineMode, MasterAlpha, CombineCallBack)
    else
      StretchHorzStretchVertLinear(Dst, DstRect, DstClip, SrcBits, SrcWidth, SrcHeight, SrcRect, OuterColor, CombineOp, CombineMode, MasterAlpha, CombineCallBack);
  end else
...
begin
  CheckBitmaps(Dst, Src);
  StretchTransferExt(Dst, DstRect, DstClip, Src.Bits, Src.Width, Src.Height,
...
begin
  ...
  begin
    ...
    if (SrcW = DstW) and (SrcH = DstH) then
      BlendBlock(Dst, DstClip, SrcBits, SrcWidth, SrcHeight, SrcRect.Left + DstClip.Left - DstRect.Left, SrcRect.Top + DstClip.Top - DstRect.Top, OuterColor, CombineOp, CombineMode, MasterAlpha, CombineCallBack)
    else
      TCustomResamplerAccess(Resampler).Resample(Dst, DstRect, DstClip, SrcBits, SrcWidth, SrcHeight, SrcRect, CombineOp, CombineMode, MasterAlpha, OuterColor, CombineCallBack);
  end;
